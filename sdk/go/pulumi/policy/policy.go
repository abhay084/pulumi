...
type StackValidationPolicy func(ctx context.Context, args StackValidationArgs)

type ResourceValidationPolicy func(ctx context.Context, args ResourceValidationArgs)
